...
/**
* Clase DatoInteger_012
* Descripcion	Es esta clase realiza la carga  de 2 datos,  presenta los valores de los datos iniciales y luego los decrementa en uno; (1)
...
public class DatoInteger_012 {
	...
	* @since	0.1
	*/
	public DatoInteger_012() { 
		setDato1(10);																																						// Initial load of a value in the specific attribute
		setDato1(100);																																						// Initial load of a value in the specific attribute
	...
	*/
	public static void main(String[] args) {
		//
		DatoInteger_012 two = new DatoInteger_012();																														// Creation, Definition and Assignment of an Object Attribute of the same class DatoInteger_012
		//
...
}																																											// Closing of the Class DatoInteger_012