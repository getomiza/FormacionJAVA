...
public class DatoInteger_006 {
	...
	* @since	0.1
	*/
	public DatoInteger_006() { setResultado(0); }																															// Closing the basic constructor method of the class
	...
	* Es el metodo que realiza el calculo aritmetico de MULTIPLICAR 2 NUMEROS DE TIPO INTEGER
	* @author Getomiza
	* @version 1.0
	* @see	none
	* @param	none
	...
	* @since	0.1
	*/
	public int calculateMultiply2Operators(int param1, int param2) { 
	...
	*/
	public static void main(String[] args) {
		//
		DatoInteger_006 two = new DatoInteger_006();																														// Creation, Definition and Assignment of an Object Attribute of the same class DatoInteger_006
		//
		two.setDato1(1111);																																					// Assigning a value to attribute 1
		two.setDato2(22);																																					// Assigning a value to attribute 2
		//
        ...
        two.calculateMultiply2Operators(two.getDato1(), two.getDato2()));																									// Message to the user, with the value of the result of the calculation operation
	}																																										// Closing the Method main
}																																											// Closing of the Class DatoInteger_006