...
/**
* Clase DatoInteger_004
* Descripcion	Es esta clase realiza la carga  de 2 datos, suma los valores contenidos en los atributos de la clase
...
public class DatoInteger_004 {
	...
	* @since	0.1
	*/
	public DatoInteger_004() { setResultado(0); }																																										// Closing the basic constructor method of the class
	...
	* @since	0.1
	*/
	public int calculateAdd2Operators(int param1, int param2) { 
	...
	*/
	public static void main(String[] args) {
		//
		DatoInteger_004 two = new DatoInteger_004();																														// Creation, Definition and Assignment of an Object Attribute of the same class DatoInteger_004
		//
		two.setDato1(12345);																																				// Assigning a value to attribute 1
		two.setDato2(1);																																					// Assigning a value to attribute 2
		//
        ...
        two.calculateAdd2Operators(two.getDato1(), two.getDato2()));																										// Message to the user, with the value of the result of the calculation operation
	}																																										// Closing the Method main
}																																											// Closing of the Class DatoInteger_004