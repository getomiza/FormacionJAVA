...
/**
* Clase DatoInteger_008
* Descripcion	Es esta clase realiza la carga  de 2 datos, obtiene el modulo d ela division de los valores contenidos en los atributos de la clase
...
public class DatoInteger_008 {
	...
	* @since	0.1
	*/
	public DatoInteger_008() { setResultado(0); }																															// Closing the basic constructor method of the class
	...
	* @since	0.1
	*/
		public int calculateModulus2Operators(int param1, int param2) { 
	...
	*/
	public static void main(String[] args) {
		//
		DatoInteger_008 two = new DatoInteger_008();																														// Creation, Definition and Assignment of an Object Attribute of the same class DatoInteger_008
		//
        ...
        two.calculateModulus2Operators(two.getDato1(), two.getDato2()));																										// Message to the user, with the value of the result of the calculation operation
	}																																										// Closing the Method main
}																																											// Closing of the Class DatoInteger_008